...
export default function AssignmentEditor() {
  ...
  if (!assignment) {
    return <Container className="py-4"><h4>Assignment not found.</h4></Container>;
  }
  return (
      ...
      <Form>
        ...
        <div className="border rounded p-3 mb-4">
          ...
          <Form.Select
            ...
            className="mb-3"
            defaultValue={assignment.submission_type.toUpperCase()}
          >
        ...
        <div className="border rounded p-3 mb-4">
          <Form.Label className="fw-bold d-block mb-2">Assign Dates</Form.Label>
