...
import { BsBellFill, BsClipboardDataFill, BsFillHouseFill, BsFillMegaphoneFill } from "react-icons/bs";
...
export default function CourseStatus() {
  return (
    <div id="wd-course-status" style={{ width: "350px" }}>
      ...
      <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
        <BsClipboardDataFill className="me-2 fs-5" /> View Course Stream </Button>
      <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
        <BsFillMegaphoneFill className="me-2 fs-5" /> New Announcement </Button>
      <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
        <BsClipboardDataFill className="me-2 fs-5" /> New Analytics </Button>
      <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
