...
This is the third paragraph. Wrap each paragraph with the paragraph tag to tell browsers to render the gaps.
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
            ...
            <li>add wet ingredients</li>
            <li>stir to combine</li>
            <li>on heated iron plate and make it thin</li>
            <li>brush some sweet soybean paste</li>
            <li>add some cabage</li>
            <li>add a sausage</li>
            <li>add some fried bread stick</li>
            <li>add some chopped green onion</li>
...
Your favorite books (in no particular order)
      ...
      <div id="wd-forms">
        ...
        <form id="wd-text-fields">
          ...
          <input placeholder="BZ" id="wd-text-fields-username" /> <br />
          <label htmlFor="wd-text-fields-password">Password:</label>
          <input type="password" value="123@#$asd" id="wd-text-fields-password" />
          <br />
          <label htmlFor="wd-text-fields-first-name">First name:</label>
          <input type="text" value="Boxun" id="wd-text-fields-first-name" /> <br />
          <label htmlFor="wd-text-fields-last-name">Last name:</label>
          <input type="text" placeholder="Zhu"
                 value="Zhu"
                 title="The last name"
      ...
      <h4>Anchor tag</h4>
      Please
      <a href="https://github.com/Zhu-B/kanbas-react-web-app.git" id="wd-lipsum">click here</a>
